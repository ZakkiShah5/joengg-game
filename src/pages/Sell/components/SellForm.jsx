...
const SellForm = () => {
  return (
    <div className='mx-auto py-4 px-4 flex flex-col justify-center items-center gap-2'>
      ...
      <form className='mt-[-20px] bg-transparent-300 w-72 p-5 rounded-b-2xl overflow-hidden'>
        ...
        <div className='py-5 border-b-mypurple-600 flex border-b justify-between items-center text-mypurple-600'>
          ...
          <div className='text-center mr-5'>
            <div className='flex items-center relative text-3xl'>
              <img src={minus} className='w-11 absolute left-[-30px]' alt='' />
              <span className='bg-purple-900 w-14 text-white'>1</span>
              <img src={plus} className='w-11 absolute right-[-30px]' alt='' />
            </div>
            <span>Max</span>
          </div>
        </div>
        ...
        <div className=' flex justify-center'>
          <button className='bg-mypurple-600 py-2 rounded-lg text-white text-2xl font-bold w-10/12'>
            Confirm
          </button>
        </div>
      </form>
      <div className='text-white text-lg'>
        <p>Exchangeable from a mnimum of 5</p>
      </div>
    </div>
  )
}
